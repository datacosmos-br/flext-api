...
class FlextApiClientAsyncRequestMixin(FlextApiClientCodecMixin):
    ...
    async def _execute_http_request(
        ...
        """Execute HTTP request using httpx async client."""
        try:
            ...
            return r[m.Api.HttpResponse].fail_op("HTTP async client request", exc)
